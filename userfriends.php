...
echo '<br><br><br><br>$friends_handler = ';
var_dump($friends_handler);
...
//echo '<br><br><br><br>$friendsrows = ';
//var_dump($friendsrows);
...
if ($honorid &&
	isset($jieqiRight['system']['maxfriends']['honors'][$honorid]) &&
