...
<caption>数据库备份</caption>
  ...
  <tr><td align="center"><a href="javascript:history.go(-1);">返回上页</a></td></tr>
</table>
';
}
echo '
...
echo '  
  ...
  <tr><td>
  <ul>
  <li>数据备份功能根据您的选择的数据表备份成文件，导出的数据文件可用“数据库恢复”功能或 phpMyAdmin 导入，默认备份文件保存在/files/system/dbbackup目录。</li>
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr align="center">
	...
	<td><a href="'.$this->_tpl_vars['log_list'][$this->_tpl_vars['i']['key']]['importurl'].'" onclick="javascript:if(confirm(\'确实要恢复该批数据吗？\\n\\n该操作会导致当前全部或部分数据丢失！恢复前请先做好数据备份工作！\')){return true;}else{return false;}">恢复</a></td>
  </tr>
';
}
echo '
