...
echo '
  ...
  <ul class="ulcenter" style="margin:10px 0">
    <li style="width:50%;float:left;"><a href="'.$this->_tpl_vars['jieqi_url'].'/newmessage.php?receiver='.urlencode($this->_tpl_vars['name']).'&ajax_gets=jieqi_contents" class="message">发送消息</a></li>
    <li style="width:50%;float:left;"><a id="addfriends" href="'.$this->_tpl_vars['jieqi_url'].'/addfriends.php?id='.$this->_tpl_vars['uid'].'"  class="friend">加为好友</a></li>
    ';
