...
<div class="read-main">
  ...
  <div id="htmlContent" class="read-content">
	...
	<div id="loadinginfo" style="position:absolute;z-index:1;top:200px;left:0px;width:100%;font-size:16px;color:blue;text-align:center;">正在载入图片，请稍候...</div>
  ...
  <div class="sidebar read-toolbar" id="rightToolbar" style="left: 80%; visibility: visible;">
    <div class="sidebar-btn">
      <ul>
        <li><a class="addto-shelf-btn" href="javascript:;" onclick="GPage.addbook(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/addbookcase.php?bid='.$this->_tpl_vars['articleid'].'&cid='.$this->_tpl_vars['cid'].'\');"><i class="icon icon-book"></i>书签</a></li>
        <li><a class="send-reward-btn" href="javascript:void(0);" onclick="huodong(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/tip.php?id='.$this->_tpl_vars['articleid'].'\');"><i class="icon icon-reward"></i>打赏</a></li>
        <li><a class="send-flower-btn" href="javascript:void(0);" onclick="huodong(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/gift.php?type=flower&id='.$this->_tpl_vars['articleid'].'\');"><i class="icon icon-flower"></i>送花</a></li>          
