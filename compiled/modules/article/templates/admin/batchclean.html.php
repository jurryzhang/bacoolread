...
<tr>
  <td class="tdl">关键字：<br />查询小说序号(ID)或者小说名<br />多个ID用英文逗号分开，不要换行，如：<br />12,34,56,78<br /><br />多个小说名则是每个一行，如：<br />小说一<br />小说二<br />小说三</td>
  <td class="tdr"><input name="idname" type="radio" value="0" checked>按小说序号，逗号分隔 &nbsp;<input name="idname" type="radio" value="1">按小说名，每个一行 <br />
  <textarea class="textarea" name="articles" id="articles" rows="10" cols="70"></textarea></td>
</tr>
<tr>
  <td class="tdl">特别说明：</td>
  <td class="tdr"><span class="hottext">以上限制条件可选择多个，如果全部留空不填，则针对所有小说进行处理。<br />数据清理不可恢复，请谨慎使用！</span></td> 
</tr> 
<tr> 
  <td class="tdl">&nbsp;</td>
  <td class="tdr"><input type="submit" name="btnclecn" value="开始清理" class="button"><input type="hidden" name="action" value="clean"></td>
</tr>
</table>
</form> ';
?>