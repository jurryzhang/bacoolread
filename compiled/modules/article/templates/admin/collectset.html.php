...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr>
    ...
    <td align="center"><a href="'.$this->_tpl_vars['article_static_url'].'/admin/collectedit.php?config='.$this->_tpl_vars['siterows'][$this->_tpl_vars['i']['key']]['config'].'">编辑</a> | <a href="javascript:if(confirm(\'确实要删除该采集规则么？\')) document.location=\''.$this->_tpl_vars['article_static_url'].'/admin/collectset.php?action=del&config='.$this->_tpl_vars['siterows'][$this->_tpl_vars['i']['key']]['config'].'\'">删除</a></td>
