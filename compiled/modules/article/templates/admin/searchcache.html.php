<?php
echo '<div class="gridtop"><a href="'.$this->_tpl_vars['article_dynamic_url'].'/admin/searchcache.php">全部搜索关键字</a> | <a href="'.$this->_tpl_vars['article_dynamic_url'].'/admin/searchcache.php?flag=title">小说搜索关键字</a> | <a href="'.$this->_tpl_vars['article_dynamic_url'].'/admin/searchcache.php?flag=author">作者搜索关键字</a> | <a href="'.$this->_tpl_vars['article_dynamic_url'].'/admin/searchcache.php?flag=notitle">找不到的小说</a> | <a href="'.$this->_tpl_vars['article_dynamic_url'].'/admin/searchcache.php?flag=noauthor">找不到的作者</a></div>
