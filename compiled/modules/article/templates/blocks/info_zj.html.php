...
echo '<li><a href="'.$this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['url_chapter'].'">';
if($this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['isvip_n'] > 0){
echo '<span class="hot"><i class="fa fa-vimeo-square fa-fw"></i></span>';
}else{
}
echo $this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['volumename'].' '.$this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['chaptername'].'</a> ['.date('Y-m-d H:i',$this->_tpl_vars['chapterrows'][$this->_tpl_vars['i']['key']]['lastupdate']).']</li>';
}
}
echo '
</ul>';
