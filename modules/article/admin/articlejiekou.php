...
if (isset($_REQUEST['action']) && !empty($_REQUEST['id'])) {
	...
	case 'aiyue':
		$article_handler->updatefields(array('aiyue' => 1), $criteria);
		break;
    
	case 'aiyues':
		$article_handler->updatefields(array('aiyue' => 0), $criteria);
		break;
	...
	case 'xiongmao':
		$article_handler->updatefields(array('xiongmao' => 1), $criteria);
		break;
    
	case 'xiongmaos':
		$article_handler->updatefields(array('xiongmao' => 0), $criteria);
		break;

	case 'chuangdu':
		$article_handler->updatefields(array('chuangdu' => 1), $criteria);
		break;
    
	case 'chuangdus':
		$article_handler->updatefields(array('chuangdu' => 0), $criteria);
		break;
...
$jieqiTset['jieqi_contents_template'] = $jieqiModules['article']['path'] . '/templates/admin/articlejiekou.html';
...
$jieqiTpl->assign('url_article', $jieqiModules['article']['url'] . '/admin/articlejiekou.php');
