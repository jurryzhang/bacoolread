<?php
@define('JIEQI_URL','http://www.mianfeidushu.com');
@define('JIEQI_SITE_NAME','快阅中文网');
@define('JIEQI_CONTACT_EMAIL','');
@define('JIEQI_MAIN_SERVER','');
@define('JIEQI_USER_ENTRY','');
@define('JIEQI_META_KEYWORDS','网络小说；小说；最新；最快；都市；总裁；架空；穿越；玄幻；校园；武侠；修真；仙侠；科幻；灵异；言情；魔法；文学；出版；免费；追书；易搜；书旗；宜搜；多看；开卷有益');
@define('JIEQI_META_DESCRIPTION','书荒必备；爽文必读，爆文必看，热文必追大型原创网络文学综合性平台');
@define('JIEQI_META_COPYRIGHT','Powered by xindong CMS &copy; 心动文化（http://www.kyread.com）');
@define('JIEQI_BANNER','');
