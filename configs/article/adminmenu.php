...
$jieqiAdminmenu['article'][] = array('layer' => 0, 'caption' => '精选管理', 'command'=>$GLOBALS['jieqiModules']['article']['url'].'/admin/tbook.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['article'][] = array('layer' => 0, 'caption' => '合作方API管理', 'command'=>$GLOBALS['jieqiModules']['article']['url'].'/admin/api.php', 'target' => 0, 'publish' => 1);
